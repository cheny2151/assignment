...
<head>
    ...
    <link rel="stylesheet" href="${contextPath}/resources/vendor/添加/添加.css">
                        ...
                        <ul class="nav" id="main-nav">
                            ...
                            <li class="has-child-item open-item active-item">
                                ...
                                <ul class="nav child-nav level-1">
                                    ...
                                    <li class="active-item"><a href="project_add.ftl">添加</a></li>
                                </ul>
                            </li>
                            <li class="has-child-item close-item">
...
<script src="${contextPath}/resources/vendor/添加/raphael.min.js"></script>
<script src="${contextPath}/resources/vendor/添加/添加.min.js"></script>
<script src="${contextPath}/resources/js/examples/项目/添加.js"></script>
</body>
