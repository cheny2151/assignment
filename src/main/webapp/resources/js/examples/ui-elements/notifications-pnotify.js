$(function () {
    ...
    $('#pnotify-feature-nonblocking').on('click',function () {
        new PNotify({
            ...
            text: 'I\'m a special kind of notice called "non-blocking". When you hover over me I\'ll fade to show the 添加 underneath. Feel free to click any of them just like I wasn\'t even here.\n\nNote: HTML links don\'t trigger in some browsers, due to security settings.',
            type: 'success',
            nonblock: {
                nonblock: true,
                nonblock_opacity: .2
